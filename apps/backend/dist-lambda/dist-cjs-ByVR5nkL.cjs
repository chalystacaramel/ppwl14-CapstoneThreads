...
const require_dist_cjs$28 = require("./dist-cjs-D8Xvoqzr.cjs");
const require_dist_cjs$29 = require("./dist-cjs-493h0nIF.cjs");
const require_dist_cjs$30 = require("./dist-cjs-Cv7lwqFB.cjs");
const require_dist_cjs$31 = require("./dist-cjs-BPUMJe9H.cjs");
const require_dist_cjs$32 = require("./dist-cjs-CthQcEjW.cjs");
const require_client = require("./client-l-N-KiY4.cjs");
const require_dist_cjs$33 = require("./dist-cjs-B4Zh07ae.cjs");
const require_dist_cjs$34 = require("./dist-cjs-EhnLoTSm.cjs");
const require_dist_cjs$35 = require("./dist-cjs-sJyDAqtz.cjs");
const require_package = require("./package-Ede9egTp.cjs");
//#region ../../node_modules/.bun/@aws-sdk+token-providers@3.1041.0/node_modules/@aws-sdk/token-providers/dist-cjs/index.js
var require_dist_cjs$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var httpAuthSchemes = (require_dist_cjs$29.init_httpAuthSchemes(), require_chunk.__toCommonJS(require_dist_cjs$29.httpAuthSchemes_exports));
	var propertyProvider = require_dist_cjs$33.require_dist_cjs();
	var sharedIniFileLoader = require_dist_cjs$34.require_dist_cjs();
	...
	const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
		const { SSOOIDCClient } = await Promise.resolve().then(() => require("./sso-oidc-CkagWBJ6.cjs"));
	...
	const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
		const { CreateTokenCommand } = await Promise.resolve().then(() => require("./sso-oidc-CkagWBJ6.cjs"));
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/auth/httpAuthSchemeProvider.js
...
var init_httpAuthSchemeProvider = require_chunk.__esmMin((() => {
	require_dist_cjs$29.init_httpAuthSchemes();
	import_dist_cjs$33 = require_dist_cjs$30.require_dist_cjs$7();
	...
	resolveHttpAuthSchemeConfig = (config) => {
		const config_0 = require_dist_cjs$29.resolveAwsSdkSigV4Config(config);
		return Object.assign(config_0, { authSchemePreference: (0, import_dist_cjs$33.normalizeProvider)(config.authSchemePreference ?? []) });
	};
}));
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/endpoint/EndpointParameters.js
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/endpoint/bdd.js
var import_dist_cjs$32, k, a, b, c, d, e, f, g, h, i, j, _data, root, r, nodes, bdd;
var init_bdd = require_chunk.__esmMin((() => {
	import_dist_cjs$32 = require_dist_cjs$29.require_dist_cjs$13();
	k = "ref";
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/endpoint/endpointResolver.js
var import_dist_cjs$30, import_dist_cjs$31, cache, defaultEndpointResolver;
var init_endpointResolver = require_chunk.__esmMin((() => {
	import_dist_cjs$30 = require_dist_cjs$29.require_dist_cjs$12();
	import_dist_cjs$31 = require_dist_cjs$29.require_dist_cjs$13();
	init_bdd();
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/models/SSOServiceException.js
var import_dist_cjs$29, SSOServiceException;
var init_SSOServiceException = require_chunk.__esmMin((() => {
	import_dist_cjs$29 = require_dist_cjs$30.require_dist_cjs();
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/models/errors.js
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/schemas/schemas_0.js
...
var init_schemas_0 = require_chunk.__esmMin((() => {
	require_dist_cjs$30.init_schema();
	init_errors();
	init_SSOServiceException();
	...
	_s_registry = require_dist_cjs$30.TypeRegistry.for(_s);
	SSOServiceException$ = [
		-3,
		_s,
		"SSOServiceException",
	...
	n0_registry = require_dist_cjs$30.TypeRegistry.for(n0);
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/runtimeConfig.shared.js
...
var init_runtimeConfig_shared = require_chunk.__esmMin((() => {
	require_dist_cjs$29.init_httpAuthSchemes();
	require_dist_cjs$29.init_protocols();
	require_dist_cjs$29.init_dist_es();
	import_dist_cjs$25 = require_dist_cjs$30.require_dist_cjs();
	import_dist_cjs$26 = require_dist_cjs$32.require_dist_cjs();
	import_dist_cjs$27 = require_dist_cjs$30.require_dist_cjs$6();
	import_dist_cjs$28 = require_dist_cjs$31.require_dist_cjs();
	...
	getRuntimeConfig$1 = (config) => {
		return {
			...
			httpAuthSchemes: config?.httpAuthSchemes ?? [{
				...
				signer: new require_dist_cjs$29.AwsSdkSigV4Signer()
			}, {
				schemeId: "smithy.api#noAuth",
				identityProvider: (ipc) => ipc.getIdentityProvider("smithy.api#noAuth") || (async () => ({})),
				signer: new require_dist_cjs$29.NoAuthSigner()
			}],
			logger: config?.logger ?? new import_dist_cjs$25.NoOpLogger(),
			protocol: config?.protocol ?? require_dist_cjs$29.AwsRestJsonProtocol,
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/runtimeConfig.js
...
var init_runtimeConfig = require_chunk.__esmMin((() => {
	...
	require_dist_cjs$29.init_httpAuthSchemes();
	import_dist_cjs$15 = require_dist_cjs$29.require_dist_cjs$4();
	import_dist_cjs$16 = require_dist_cjs$29.require_dist_cjs$9();
	import_dist_cjs$17 = require_dist_cjs$29.require_dist_cjs$3();
	import_dist_cjs$18 = require_dist_cjs$29.require_dist_cjs$6();
	import_dist_cjs$19 = require_dist_cjs$35.require_dist_cjs();
	import_dist_cjs$20 = require_dist_cjs$30.require_dist_cjs$4();
	import_dist_cjs$21 = require_dist_cjs$30.require_dist_cjs();
	import_dist_cjs$22 = require_dist_cjs$29.require_dist_cjs$2();
	import_dist_cjs$23 = require_dist_cjs$29.require_dist_cjs$1();
	...
	getRuntimeConfig = (config) => {
		...
		return {
			...
			runtime: "node",
			defaultsMode,
			authSchemePreference: config?.authSchemePreference ?? (0, import_dist_cjs$19.loadConfig)(require_dist_cjs$29.NODE_AUTH_SCHEME_PREFERENCE_OPTIONS, loaderConfig),
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/auth/httpAuthExtensionConfiguration.js
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/runtimeExtensions.js
...
var init_runtimeExtensions = require_chunk.__esmMin((() => {
	import_dist_cjs$12 = require_dist_cjs$29.require_dist_cjs();
	import_dist_cjs$13 = require_dist_cjs$28.require_dist_cjs();
	import_dist_cjs$14 = require_dist_cjs$30.require_dist_cjs();
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/SSOClient.js
...
var init_SSOClient = require_chunk.__esmMin((() => {
	import_dist_cjs$3 = require_dist_cjs$29.require_dist_cjs$16();
	import_dist_cjs$4 = require_dist_cjs$29.require_dist_cjs$15();
	import_dist_cjs$5 = require_dist_cjs$29.require_dist_cjs$14();
	import_dist_cjs$6 = require_dist_cjs$29.require_dist_cjs$11();
	import_dist_cjs$7 = require_dist_cjs$29.require_dist_cjs$9();
	require_dist_cjs$29.init_dist_es();
	require_dist_cjs$30.init_schema();
	import_dist_cjs$8 = require_dist_cjs$29.require_dist_cjs$8();
	import_dist_cjs$9 = require_dist_cjs$29.require_dist_cjs$7();
	import_dist_cjs$10 = require_dist_cjs$29.require_dist_cjs$6();
	import_dist_cjs$11 = require_dist_cjs$30.require_dist_cjs();
	init_httpAuthSchemeProvider();
	...
	SSOClient = class extends import_dist_cjs$11.Client {
		...
		constructor(...[configuration]) {
			...
			this.middlewareStack.use(require_dist_cjs$30.getSchemaSerdePlugin(this.config));
			...
			this.middlewareStack.use(require_dist_cjs$29.getHttpAuthSchemeEndpointRuleSetPlugin(this.config, {
				httpAuthSchemeParametersProvider: defaultSSOHttpAuthSchemeParametersProvider,
				identityProviderConfigProvider: async (config) => new require_dist_cjs$29.DefaultIdentityProviderConfig({ "aws.auth#sigv4": config.credentials })
			}));
			this.middlewareStack.use(require_dist_cjs$29.getHttpSigningPlugin(this.config));
		}
		destroy() {
			super.destroy();
		}
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/commands/GetRoleCredentialsCommand.js
var import_dist_cjs$1, import_dist_cjs$2, GetRoleCredentialsCommand;
var init_GetRoleCredentialsCommand = require_chunk.__esmMin((() => {
	import_dist_cjs$1 = require_dist_cjs$29.require_dist_cjs$7();
	import_dist_cjs$2 = require_dist_cjs$30.require_dist_cjs();
	init_EndpointParameters();
	init_schemas_0();
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/SSO.js
var import_dist_cjs, commands, SSO;
var init_SSO = require_chunk.__esmMin((() => {
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/commands/index.js
var init_commands = require_chunk.__esmMin((() => {
	init_GetRoleCredentialsCommand();
}));
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/models/models_0.js
var init_models_0 = require_chunk.__esmMin((() => {}));
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+nested-clients@3.997.6/node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/index.js
var sso_exports = /* @__PURE__ */ require_chunk.__exportAll({
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+credential-provider-sso@3.972.38/node_modules/@aws-sdk/credential-provider-sso/dist-cjs/loadSso-BKDNrsal.js
var require_loadSso_BKDNrsal = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	var sso = (init_sso(), require_chunk.__toCommonJS(sso_exports));
	exports.GetRoleCredentialsCommand = sso.GetRoleCredentialsCommand;
	exports.SSOClient = sso.SSOClient;
}));
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+credential-provider-sso@3.972.38/node_modules/@aws-sdk/credential-provider-sso/dist-cjs/index.js
