...
const require_dist_cjs$4 = require("./dist-cjs-CthQcEjW.cjs");
const require_dist_cjs$5 = require("./dist-cjs-B4Zh07ae.cjs");
const require_dist_cjs$6 = require("./dist-cjs-sJyDAqtz.cjs");
//#region ../../node_modules/.bun/@smithy+credential-provider-imds@4.2.14/node_modules/@smithy/credential-provider-imds/dist-cjs/index.js
var require_dist_cjs = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var nodeConfigProvider = require_dist_cjs$6.require_dist_cjs();
	var urlParser = require_dist_cjs$4.require_dist_cjs();
