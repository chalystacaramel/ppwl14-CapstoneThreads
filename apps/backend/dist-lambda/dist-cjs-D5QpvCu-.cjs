...
const require_dist_cjs$5 = require("./dist-cjs-D8Xvoqzr.cjs");
const require_client = require("./client-l-N-KiY4.cjs");
const require_dist_cjs$6 = require("./dist-cjs-B4Zh07ae.cjs");
const require_dist_cjs$7 = require("./dist-cjs-EhnLoTSm.cjs");
//#region ../../node_modules/.bun/@aws-sdk+credential-provider-login@3.972.38/node_modules/@aws-sdk/credential-provider-login/dist-cjs/index.js
var require_dist_cjs$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var LoginCredentialsFetcher = class LoginCredentialsFetcher {
		...
		async refresh(token) {
			const { SigninClient, CreateOAuth2TokenCommand } = await Promise.resolve().then(() => require("./signin-BPrM_7WJ.cjs"));
...
//#endregion
//#region ../../node_modules/.bun/@aws-sdk+credential-provider-ini@3.972.38/node_modules/@aws-sdk/credential-provider-ini/dist-cjs/index.js
var require_dist_cjs = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	const resolveCredentialSource = (credentialSource, profileName, logger) => {
		const sourceProvidersMap = {
			EcsContainer: async (options) => {
				const { fromHttp } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-CX1QRd57.cjs").default));
				const { fromContainerMetadata } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-BJYtsQtW.cjs").default));
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is EcsContainer");
				return async () => propertyProvider.chain(fromHttp(options ?? {}), fromContainerMetadata(options))().then(setNamedProvider);
			},
			Ec2InstanceMetadata: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Ec2InstanceMetadata");
				const { fromInstanceMetadata } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-BJYtsQtW.cjs").default));
				return async () => fromInstanceMetadata(options)().then(setNamedProvider);
			},
			Environment: async (options) => {
				logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
				const { fromEnv } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-n4JhwAFP.cjs").default));
	...
	const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
		...
		if (!options.roleAssumer) {
			const { getDefaultRoleAssumer } = await Promise.resolve().then(() => require("./sts-xx4yGbfR.cjs"));
	...
	const resolveProcessCredentials = async (options, profile) => Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-D8Ty2432.cjs").default)).then(({ fromProcess }) => fromProcess({
		...options,
		profile
	...
	const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
		const { fromSSO } = await Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-ByVR5nkL.cjs").default));
		return fromSSO({
			profile,
			logger: options.logger,
	...
	const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => Promise.resolve().then(() => /* @__PURE__ */ require_chunk.__toESM(require("./dist-cjs-_Oh7DS9E.cjs").default)).then(({ fromTokenFile }) => fromTokenFile({
